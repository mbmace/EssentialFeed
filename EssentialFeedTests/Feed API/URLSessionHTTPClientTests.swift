...
//  EssentialFeedTests
//
//  Created by Matthias Sehrbrock on 23.02.21.
//
...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnAllInvalidReprestantionCases() {
    ...
    func test_getFromURL_succeedsWithsEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
